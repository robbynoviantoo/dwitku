      ...
      >
        ...
        <View style={styles.absoluteLayer} pointerEvents="none">
          <Svg width="100%" height="100%">
            ...
            {/* Render Glows */}
            <Rect width="100%" height="100%" fill="url(#wallet-glow-top-right)" />
            <Rect width="100%" height="100%" fill="url(#wallet-glow-bottom-left)" />

            {/* Render Grid Pattern */}
            <Rect width="100%" height="100%" fill="url(#wallet-hero-grid-pattern)" />
          </Svg>
        </View>

        {/* Card Content */}
        <View style={styles.heroCardContent}>
          {/* Badge Total Saldo Dompet */}
          <View style={styles.heroBadge}>
            <Sparkles size={12} color="#86efac" />
            <Text style={styles.heroBadgeText}>Total Saldo Dompet</Text>
          </View>

          {/* Nominal Besar Total Saldo */}
          <Text style={styles.heroAmount} numberOfLines={1} adjustsFontSizeToFit>
            {showAmount ? formatRupiah(totalWalletBalance) : '••••••••'}
          </Text>

          <Text style={styles.accumulatedSubtitle}>
            Akumulasi dari {walletsCount} dompet / rekening aktif
          </Text>
