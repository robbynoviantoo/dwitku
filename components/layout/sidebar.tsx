...
export function Sidebar({
  ...
  return (
    <aside
      ...
      className="flex flex-col h-full fixed left-0 top-0 z-50 overflow-hidden"
    >
      {/* ── Header: Logo + Toggle ── */}
      <div
        ...
        {collapsed ? (
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={toggleCollapsed}
              style={{ color: "var(--sidebar-text)" }}
              className="p-1.5 rounded-lg hover:bg-[var(--sidebar-item-bg-hover)] transition-colors shrink-0"
      ...
      >
        ...
        <button
          ...
          style={{ color: "var(--sidebar-text)" }}
          className={cn(
            "w-full flex items-center gap-3 rounded-lg text-sm transition-colors hover:bg-[var(--sidebar-item-bg-hover)]",
