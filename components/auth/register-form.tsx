    ...
    return (
        <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-zinc-100">
            <div className="text-center mb-8">
                <h1 className="text-2xl font-bold text-zinc-900">Buat Akun Dwitku</h1>
                <p className="text-sm text-zinc-500 mt-2">Mulai kelola keuanganmu jadi lebih mudah</p>
            </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <button
                    disabled={isPending}
                    type="submit"
                    className="w-full cursor-pointer bg-green-600 hover:bg-green-700 text-white font-medium py-2.5 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
                    {isPending
            ...
            <div className="mt-6 flex items-center">
                ...
                <span className="px-4 text-sm text-zinc-500">Atau daftar dengan</span>
                <div className="flex-1 border-t border-zinc-200"></div>
            </div>
