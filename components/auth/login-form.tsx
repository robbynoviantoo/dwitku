    ...
    return (
        <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-sm border border-zinc-100">
            <div className="text-center mb-8">
                <h1 className="text-2xl font-bold text-zinc-900">Selamat Kembali</h1>
                <p className="text-sm text-zinc-500 mt-2">Masuk untuk melihat catatan keuanganmu.</p>
            </div>
            ...
            <div className="mt-6 flex items-center">
                ...
                <span className="px-4 text-sm text-zinc-500">Atau masuk dengan</span>
                <div className="flex-1 border-t border-zinc-200"></div>
            </div>
